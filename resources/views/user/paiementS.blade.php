                ...
                <div class="col-lg-9">
                    <div class="main-container">
                        <div class="mt-4 mb-4" style="margin-left: 10%">
                            <form style="width: 65%; border-radius:15px;border:1px solid antiquewhite " class="p-4 shadow-sm bg-blue" method="post" action="{{ route('paiement_service') }}">
                                @csrf

                                <div class="mb-3">
                                    <label for="bou" class="form-label">Boutique</label>
                                    <select name="boutique" id="bou">
