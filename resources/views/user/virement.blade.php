                ...
                <div class="col-lg-9">
                    <div class="main-container">
                        <div class="mt-4 mb-4" style="margin-left: 10%">
                            <form style="width: 65%; border-radius:15px;border:1px solid antiquewhite " class="p-4 shadow-sm bg-blue" method="post" action="{{ route('virement1') }}">
                                @csrf

                                <div class="mb-3">
                                    <label for="rib" class="form-label">Numero de compte</label>
