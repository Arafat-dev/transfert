                ...
                <div class="col-lg-9">
                    <div class="main-container">
                      ...
                      <div class="mt-4 mb-4" style="margin-left: 10%">
                        ...
                        <form style="width: 65%; border-radius:15px;border:1px solid antiquewhite " class="p-4 bg-blue shadow-sm" method="POST" action="{{ route('user.retrait') }}">
                            @csrf


                            <div class="mb-3">
                                <label for="numero" class="form-label">Numero sous Compte</label>
