                ...
                <div class="col-lg-9">
                    <div class="main-container">
                      ...
                      <div class="mt-4 mb-4" style="margin-left: 10%">
                            ...
                            <form style="width: 65%; border-radius:15px;border:1px solid antiquewhite"
                              class="p-4 shadow-sm bg-blue" method="POST" action="{{ route('user.transfert') }}">
                                @csrf

                                <div class="mb-3">
                                    <label for="numCompte" class="form-label">Numero de telephone</label>
                                    <input type="text" class="form-control" name="numCompte" id="numCompte">
                                </div>

                                <div class="mb-3">
                                    <label for="operateur">Operateur</label>
                                     <select name="operateur" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="operateur">
